...
public class LobbyState extends BasicGameState implements KeyListener{
	...
	public void init(GameContainer gc, final StateBasedGame s) throws SlickException {
		 ...
		 */
		Button Back = new Button(Windows.scWidth/2 - bWidth/2, Windows.scHeight/2 - bHeight/2 + bHeight, bWidth, bHeight, 15, "Back", this) {
			@Override
		...
		Button Join = new Button(Windows.scWidth/2 - bWidth/2, Windows.scHeight/2 - bHeight/2, bWidth, bHeight, 15, "Join",this) {
			@Override
			public void isClicked() {
		 ...
		 * 
		 **/
		Button SearchForGame = new Button(Windows.scWidth/2 - bWidth/2, Windows.scHeight/2 - bHeight/2 - bHeight, bWidth, bHeight, 15, "Search",this) {
			@Override
			public void isClicked() {
				findGame = true;
				...
				TextBox portBox = new TextBox(Windows.scWidth/2 - tWidth/4, Windows.scHeight/2 + tHeight, tWidth/2, tHeight, 10, this.state){
	...
	public void render(GameContainer gc, StateBasedGame s, Graphics g) throws SlickException {
		...
		if(findGame == true){
			...
			Resource.warningFont.drawString(Windows.scWidth/2 - tWidth/4, Windows.scHeight/2 - tHeight/2 - fY, "Enter your server IP", new Color(0, 0, 0));
			Resource.warningFont.drawString(Windows.scWidth/2 - tWidth/4, Windows.scHeight/2 + fY, "Enter server port", new Color(0, 0, 0));
		}
	}
